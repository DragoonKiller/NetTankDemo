...
namespace Utils
{
    ...
    public static partial class Maths
    {
        ...
        public static float Random(this (float l, float r) a) => UnityEngine.Random.Range(a.l, a.r); 
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Random(this (int l, int r) a) => UnityEngine.Random.Range(a.l, a.r - 1); 
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref int CountDown(this ref int t, int resetVal)
        {
            t = (t - 1).Max(0);
            return ref t;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool UpdateTo(this ref int a, int b)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool UpdateTo(this ref float a, float b)
        {
            if(a != b) { a = b; return true; }
            return false;
        }
        
        // Unity 目前不支持 C# 8.0 中的 ref class 特性.
        // [MethodImpl(MethodImplOptions.AggressiveInlining)]
        // public static bool UpdateTo<T>(this T a, T b) where T : IEquatable<T>
        // {
        //     if(!a.Equals(b)) { a = b; return true; }
        //     return false;
        // }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool CountDownLoop(this ref int t, int resetVal)
        {
            t = (t - 1).Max(0);
            bool res = t == 0;
            if(res) t = resetVal;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref float CountDownTime(this ref float t) 
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool CountDownTimeLoop(this ref float t, float resetVal)
        {
            t = (t - Time.deltaTime).Max(0);
            bool res = t == 0;
            if(res) t = resetVal;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int RandomWithout(this (int l, int r) sec, int v)
        {
            // 不能连续两次选重复的.
            var cid = UnityEngine.Random.Range(sec.l, sec.r);
            if(cid >= v) cid += 1;
            return cid;
        }
        
        /// <summary>
        /// 把角度限制在 (-180, 180] 的值域范围内.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float NormAngleDeg(this float x)
        {
            var xs = x.ModSys(360);
            return xs > 180 ? xs - 360 : xs;
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float NormAngleRad(this float x)
        {
            var xs = x.ModSys(2 * Mathf.PI);
            return xs > Mathf.PI ? xs - 2 * Mathf.PI : xs;
        }
        
        
        
        /// <summary>
        /// 返回 a 和 b 在模 m 剩余系下的距离.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float DistInModSys(this float a, float b, float m)
        {
            var delta = (a - b).ModSys(m);
            return delta.Max(m - delta);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int DistInModSys(this int a, int b, int m)
        {
            var delta = (a - b).ModSys(m);
            return delta.Max(m - delta);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Clamp(this int a, int l, int r) => Mathf.Clamp(a, l, r);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float Clamp(this float a, float l, float r) => Mathf.Clamp(a, l, r);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector3 Len(this Vector3 a, float z) => a.normalized * z;
